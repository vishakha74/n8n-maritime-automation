...
State between workflow 02 (enquiry) and workflow 03 (form) is kept in an n8n Data Table named **VSL UTM Form Sessions**.
...
|---|---|---|
| project_id | 02 | `VSL-MV-DEMO-TRADER-2026-10-14` |
